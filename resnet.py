...
# Função para salvar relatório de métricas
def save_classification_report(labels, preds, epoch):
    report = classification_report(labels, preds, output_dict=True)
    report_df = pd.DataFrame(report).transpose()
    report_df.to_csv(os.path.join(reports_dir, f"resnet_classification.csv"))
