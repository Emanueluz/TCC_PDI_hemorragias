...
IMAGE_DIR = "/home/emanuel/Imagens/dataset_pre_pro/"  # substitua pelo caminho real
TRAIN_CSV = '/home/emanuel/Documentos/tcc/genesis-brain-hemorrhage-main/data/rsna/data_csv_files/tiny_files/train.csv'          # substitua pelo caminho real
...
# Carregar o modelo ConvNeXt pré-treinado
...
# Definir a função de perda para classificação multiclasse
...
for epoch in range(NUM_EPOCHS):
    ...
    if accuracy > best_val_accuracy:
        ...
        best_model_path = os.path.join(results_dir, f"ConvNeXt-best_model_epoch_{epoch + 1}.pth")
